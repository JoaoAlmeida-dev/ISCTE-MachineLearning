...
def assign3_exercise2(a: np.ndarray, b: np.ndarray, c: np.ndarray):
    ...
    plt.plot(r2_List_NPArray[0][0], r2_List_NPArray[1][0],'*', label="r2first", color='brown')
...
if __name__ == '__main__':
    ...
    assign3_exercise2(points1, points2, pointsconcat)
